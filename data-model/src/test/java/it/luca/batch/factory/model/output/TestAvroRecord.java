...
public class TestAvroRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4984152466357379100L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TestAvroRecord\",\"namespace\":\"it.luca.batch.factory.model.output\",\"fields\":[{\"name\":\"data_invio\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\"},\"null\"]}]}");
   ...
   */
  public static it.luca.batch.factory.model.output.TestAvroRecord.Builder newBuilder() {
    return new it.luca.batch.factory.model.output.TestAvroRecord.Builder();
  }
   ...
   * @return A new TestAvroRecord RecordBuilder
   */
  public static it.luca.batch.factory.model.output.TestAvroRecord.Builder newBuilder(it.luca.batch.factory.model.output.TestAvroRecord.Builder other) {
    if (other == null) {
      return new it.luca.batch.factory.model.output.TestAvroRecord.Builder();
    } else {
      return new it.luca.batch.factory.model.output.TestAvroRecord.Builder(other);
    }
  }
   ...
   * @return A new TestAvroRecord RecordBuilder
   */
  public static it.luca.batch.factory.model.output.TestAvroRecord.Builder newBuilder(it.luca.batch.factory.model.output.TestAvroRecord other) {
    if (other == null) {
      return new it.luca.batch.factory.model.output.TestAvroRecord.Builder();
    } else {
      return new it.luca.batch.factory.model.output.TestAvroRecord.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TestAvroRecord>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(it.luca.batch.factory.model.output.TestAvroRecord.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(it.luca.batch.factory.model.output.TestAvroRecord other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.data_invio)) {
        this.data_invio = data().deepCopy(fields()[0].schema(), other.data_invio);
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.batch.factory.model.output.TestAvroRecord.Builder setDataInvio(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public it.luca.batch.factory.model.output.TestAvroRecord.Builder clearDataInvio() {
      data_invio = null;
